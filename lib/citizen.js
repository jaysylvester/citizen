...
CTZN.config.citizen.gzip.mimeTypes = CTZN.config.citizen.gzip.mimeTypes.split(' ');
          ...
          switch ( fileExtension ) {
            ...
            case '.pug':
              ...
              switch ( finalConfig.citizen.mode ) {
                case 'production':
                  patterns.views[directory][viewName].compiled = pug.compile(viewContents, {
                    filename: filePath,
                    compileDebug: false,
                    pretty: finalConfig.citizen.format.html.pretty
                  });
                  break;
                case 'development':
                case 'debug':
