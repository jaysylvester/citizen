...
function createServer() {
  ...
  if ( CTZN.config.citizen.http.enabled ) {
    ...
    let appUrl = 'http://' + ( CTZN.config.citizen.http.hostname.length ? CTZN.config.citizen.http.hostname : '127.0.0.1' ) + ':' + ( CTZN.config.citizen.http.port === 80 ? '' : ':' + CTZN.config.citizen.http.port ) + CTZN.config.citizen.urlPaths.app
  ...
  if ( CTZN.config.citizen.https.enabled ) {
    ...
    if ( startHttps ) {
      ...
      let appUrl = 'https://' + ( CTZN.config.citizen.https.hostname.length ? CTZN.config.citizen.https.hostname : '127.0.0.1' ) + ':' + ( CTZN.config.citizen.http.port === 443 ? '' : ':' + CTZN.config.citizen.http.port ) + CTZN.config.citizen.urlPaths.app
