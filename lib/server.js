    ...
    requestDomain.run( function () {
      ...
      if ( !params.route.isStatic ) {
        ...
        fs.readFile(staticPath, function (err, data) {
          if ( err ) {
            throw {
              thrownBy: 'server.createServer(), static file server',
              statusCode: 404,
              staticAsset: true,
  ...
  responseDomain.run( function () {
    listen({
      ...
      var requestContext = helpers.extend(context, output.pattern),
          ...
          renderedView = handoff.view || handoff.controller || requestContext.view || params.route.renderedView,
          contentType;
          ...
          if ( handoff.controller ) {
            ...
            if ( !handoffController ) {
              throw {
                ...
                message: 'The requested controller (' + handoff.controller + ') doesn\'t exist.'
              };
            }
