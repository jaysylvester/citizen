    ...
    if ( params.route.chain[link].context.view !== false ) {
        ...
        for ( const include of Object.keys(params.route.chain[link].content.include) ) {
          ...
          includes[includeInstance] = ( async () => {
            ...
            if ( params.route.chain[link].content.include[include].render ) {
              ...
              let includeContent
              try {
                includeContent = setViewContent(params, context, params.route.chain[link].content.include[include].context.content, params.route.chain[link].content.include[include].params)
              } catch ( err ) {
                return Promise.reject(err)
              }
      ...
      await Promise.allSettled(includes).then( async (results) => {
        ...
        if ( params.route.chain[link].render ) {
          ...
          let linkContent
          try {
            linkContent = setViewContent(params, context, params.route.chain[link].context.content, params.route.chain[link].params)
          } catch ( err ) {
...
function setViewContent(params, context, itemContent, itemParams) {
  let viewContent
