  ...
  for ( var property in cookies ) {
    if ( cookies.hasOwnProperty(property) ) {
      ...
      if ( cookies[property].constructor !== Object ) {
        ...
        cookieArray.push(property + '=' + cookies[property] + ';path=' + CTZN.config.citizen.urlPaths.app + ';HttpOnly;SameSite=Lax;' + secure)
      } else {
        defaults = {
          value: '',
        ...
        cookieArray.push(property + '=' + cookie.value + ';' + path + expires + httpOnly + sameSite + secure)
      }
    }
  }
