      ...
      if ( params.route.chain[link].content && params.route.chain[link].content.include ) {
        ...
        for ( const include of Object.keys(params.route.chain[link].content.include) ) {
          ...
          if ( params.route.chain[link].content.include[include].render ) {
            ...
            let includeContent = setViewContent(params, context, params.route.chain[link].content.include[include].context, params.route.chain[link].content.include[include].params)
            ...
            parentContent.include[include] = await renderView({
    ...
    case 'html':
      if ( CTZN.patterns.views[options.pattern][options.view] ) {
        ...
        try {
          ...
          server.emit('error', err, options.params, options.content)
        }
      } else {
